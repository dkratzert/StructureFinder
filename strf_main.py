...
class Ui_stdbMainwindow(object):
    def setupUi(self, stdbMainwindow):
        ...
        self.gridLayout_4.addWidget(self.r1Label_2, 4, 0, 1, 1)
        self.ad_r1LineEdit = QtWidgets.QLineEdit(self.searchtab)
        self.ad_r1LineEdit.setObjectName("ad_r1LineEdit")
        self.gridLayout_4.addWidget(self.ad_r1LineEdit, 4, 1, 1, 1)
        ...
        self.ad_machineLineEdit = QtWidgets.QLineEdit(self.searchtab)
        self.ad_machineLineEdit.setObjectName("ad_machineLineEdit")
        self.gridLayout_4.addWidget(self.ad_machineLineEdit, 3, 1, 1, 1)
        self.ad_TwinCheckBox = QtWidgets.QCheckBox(self.searchtab)
        self.ad_TwinCheckBox.setText("")
        self.ad_TwinCheckBox.setObjectName("ad_TwinCheckBox")
        self.gridLayout_4.addWidget(self.ad_TwinCheckBox, 7, 1, 1, 1)
        self.ad_DisorderCheckBox = QtWidgets.QCheckBox(self.searchtab)
        self.ad_DisorderCheckBox.setText("")
        self.ad_DisorderCheckBox.setObjectName("ad_DisorderCheckBox")
        self.gridLayout_4.addWidget(self.ad_DisorderCheckBox, 6, 1, 1, 1)
        self.ad_elementsExLineEdit = QtWidgets.QLineEdit(self.searchtab)
        self.ad_elementsExLineEdit.setObjectName("ad_elementsExLineEdit")
        self.gridLayout_4.addWidget(self.ad_elementsExLineEdit, 2, 1, 1, 1)
        self.disorderLabel = QtWidgets.QLabel(self.searchtab)
        self.disorderLabel.setObjectName("disorderLabel")
        self.gridLayout_4.addWidget(self.disorderLabel, 6, 0, 1, 1)
        self.elementsExcludedLabel = QtWidgets.QLabel(self.searchtab)
        self.elementsExcludedLabel.setObjectName("elementsExcludedLabel")
        self.gridLayout_4.addWidget(self.elementsExcludedLabel, 2, 0, 1, 1)
        self.TwinnedLabel = QtWidgets.QLabel(self.searchtab)
        self.TwinnedLabel.setObjectName("TwinnedLabel")
        self.gridLayout_4.addWidget(self.TwinnedLabel, 7, 0, 1, 1)
        ...
        self.verticalLayout.addWidget(self.ad_SearchPushButton)
