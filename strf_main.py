...
class Ui_stdbMainwindow(object):
    def setupUi(self, stdbMainwindow):
        ...
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.unitCellLabel)
        self.unitCellLineEdit = QtWidgets.QLineEdit(self.searchtab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.unitCellLineEdit.sizePolicy().hasHeightForWidth())
        self.unitCellLineEdit.setSizePolicy(sizePolicy)
        self.unitCellLineEdit.setObjectName("unitCellLineEdit")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.unitCellLineEdit)
        self.sumFormulaLabel = QtWidgets.QLabel(self.searchtab)
        self.sumFormulaLabel.setObjectName("sumFormulaLabel")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.sumFormulaLabel)
        self.sumFormulaLineEdit = QtWidgets.QLineEdit(self.searchtab)
        self.sumFormulaLineEdit.setObjectName("sumFormulaLineEdit")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.sumFormulaLineEdit)
        self.elementsIncludedLabel = QtWidgets.QLabel(self.searchtab)
        self.elementsIncludedLabel.setObjectName("elementsIncludedLabel")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.elementsIncludedLabel)
        self.elementsIncludedLineEdit = QtWidgets.QLineEdit(self.searchtab)
        self.elementsIncludedLineEdit.setObjectName("elementsIncludedLineEdit")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.elementsIncludedLineEdit)
        self.elementsExcludedLabel = QtWidgets.QLabel(self.searchtab)
        self.elementsExcludedLabel.setObjectName("elementsExcludedLabel")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.elementsExcludedLabel)
        self.elementsExcludedLineEdit = QtWidgets.QLineEdit(self.searchtab)
        self.elementsExcludedLineEdit.setObjectName("elementsExcludedLineEdit")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.elementsExcludedLineEdit)
        self.machineLabel = QtWidgets.QLabel(self.searchtab)
        self.machineLabel.setObjectName("machineLabel")
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.machineLabel)
        self.machineLineEdit = QtWidgets.QLineEdit(self.searchtab)
        self.machineLineEdit.setObjectName("machineLineEdit")
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.machineLineEdit)
        self.temperatureLabel_2 = QtWidgets.QLabel(self.searchtab)
        self.temperatureLabel_2.setObjectName("temperatureLabel_2")
        self.formLayout_4.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.temperatureLabel_2)
        self.temperatureLineEdit_2 = QtWidgets.QLineEdit(self.searchtab)
        self.temperatureLineEdit_2.setObjectName("temperatureLineEdit_2")
        self.formLayout_4.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.temperatureLineEdit_2)
        self.r1Label_2 = QtWidgets.QLabel(self.searchtab)
        self.r1Label_2.setObjectName("r1Label_2")
        self.formLayout_4.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.r1Label_2)
        self.r1LineEdit_2 = QtWidgets.QLineEdit(self.searchtab)
        self.r1LineEdit_2.setObjectName("r1LineEdit_2")
        self.formLayout_4.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.r1LineEdit_2)
        self.wR2Label_2 = QtWidgets.QLabel(self.searchtab)
        self.wR2Label_2.setObjectName("wR2Label_2")
        self.formLayout_4.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.wR2Label_2)
        self.wR2LineEdit_2 = QtWidgets.QLineEdit(self.searchtab)
        self.wR2LineEdit_2.setObjectName("wR2LineEdit_2")
        self.formLayout_4.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.wR2LineEdit_2)
        self.disorderLabel = QtWidgets.QLabel(self.searchtab)
        self.disorderLabel.setObjectName("disorderLabel")
        self.formLayout_4.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.disorderLabel)
        self.DisorderCheckBox = QtWidgets.QCheckBox(self.searchtab)
        self.DisorderCheckBox.setText("")
        self.DisorderCheckBox.setObjectName("DisorderCheckBox")
        self.formLayout_4.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.DisorderCheckBox)
        self.TwinnedLabel = QtWidgets.QLabel(self.searchtab)
        self.TwinnedLabel.setObjectName("TwinnedLabel")
        self.formLayout_4.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.TwinnedLabel)
        self.TwinCheckBox = QtWidgets.QCheckBox(self.searchtab)
        self.TwinCheckBox.setText("")
        self.TwinCheckBox.setObjectName("TwinCheckBox")
        self.formLayout_4.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.TwinCheckBox)
        self.verticalLayout.addLayout(self.formLayout_4)
        spacerItem10 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        self.verticalLayout.addItem(spacerItem10)
        self.SearchPushButton = QtWidgets.QPushButton(self.searchtab)
    ...
    def retranslateUi(self, stdbMainwindow):
        ...
        self.elementsIncludedLabel.setText(_translate("stdbMainwindow", "Elements Included"))
        self.elementsExcludedLabel.setText(_translate("stdbMainwindow", "Elements Excluded"))
        self.machineLabel.setText(_translate("stdbMainwindow", "Machine"))
        self.temperatureLabel_2.setText(_translate("stdbMainwindow", "Temperature"))
        self.r1Label_2.setText(_translate("stdbMainwindow", "R1"))
        self.wR2Label_2.setText(_translate("stdbMainwindow", "wR2"))
        self.disorderLabel.setText(_translate("stdbMainwindow", "Disordered"))
        self.TwinnedLabel.setText(_translate("stdbMainwindow", "Twinned"))
        self.SearchPushButton.setText(_translate("stdbMainwindow", "Search"))
