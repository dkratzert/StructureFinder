...
class Ui_stdbMainwindow(object):
    def setupUi(self, stdbMainwindow):
        ...
        self.gridLayout_5.addWidget(self.cellField, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.CellLabel, 0, 0, 1, 1)
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.temperatureLabel)
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.temperatureLineEdit)
        ...
        self.formLayout_3.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.r1Label)
        self.r1LineEdit = QtWidgets.QLineEdit(self.resultsGroupBox)
        self.r1LineEdit.setObjectName("r1LineEdit")
        self.formLayout_3.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.r1LineEdit)
        ...
        self.formLayout_3.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.goofLabel)
        self.goofLineEdit = QtWidgets.QLineEdit(self.resultsGroupBox)
        self.goofLineEdit.setObjectName("goofLineEdit")
        self.formLayout_3.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.goofLineEdit)
        ...
        self.formLayout_3.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.maxShiftLabel)
        self.maxShiftLineEdit = QtWidgets.QLineEdit(self.resultsGroupBox)
        self.maxShiftLineEdit.setObjectName("maxShiftLineEdit")
        self.formLayout_3.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.maxShiftLineEdit)
        ...
        self.formLayout_3.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.peakLabel)
        self.peakLineEdit = QtWidgets.QLineEdit(self.resultsGroupBox)
        self.peakLineEdit.setObjectName("peakLineEdit")
        self.formLayout_3.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.peakLineEdit)
        ...
        self.formLayout_3.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.rintLabel)
        self.rintLineEdit = QtWidgets.QLineEdit(self.resultsGroupBox)
        self.rintLineEdit.setObjectName("rintLineEdit")
        self.formLayout_3.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.rintLineEdit)
        ...
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.sumFormulaLabel)
        ...
        self.formLayout_3.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.wR2Label)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.SpaceGroupLineEdit)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.SpaceGrouplabel)
        ...
        self.openglview = QtWidgets.QWidget(self.resultsGroupBox)
        ...
        self.openglVlayout = QtWidgets.QHBoxLayout(self.openglview)
        self.openglVlayout.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        self.openglVlayout.setContentsMargins(0, 0, 0, 0)
        self.openglVlayout.setObjectName("openglVlayout")
        self.oglLayout = QtWidgets.QGridLayout()
        self.oglLayout.setObjectName("oglLayout")
        self.openglVlayout.addLayout(self.oglLayout)
