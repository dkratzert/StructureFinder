...
class Ui_stdbMainwindow(object):
    def setupUi(self, stdbMainwindow):
        ...
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.openglview)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.glvert = QtWidgets.QVBoxLayout()
        self.glvert.setObjectName("glvert")
        self.verticalLayout_8.addLayout(self.glvert)
