...
class Ui_stdbMainwindow(object):
    ...
    def retranslateUi(self, stdbMainwindow):
        ...
        self.cifList_treeWidget.headerItem().setText(1, _translate("stdbMainwindow", "cell", None))
        self.cifList_treeWidget.headerItem().setText(2, _translate("stdbMainwindow", "dir", None))
