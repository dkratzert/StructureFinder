...
<div class="row mb-3" id="mainsearch">
    ...
    <div class="col-sm-6">
        <div class="input-group input-group-sm">
            <span class="input-group-text" data-bs-toggle="tooltip" title="Search text in structure files">Text</span>
