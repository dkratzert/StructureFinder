...
def start_installer(setup_file: Path) -> None:
    ...
    Every handle StructureFinder might hold in the installation directory is released before, the
    process itself has to end immediately afterwards (see `structurefinder.misc.dialogs`).  A machine
