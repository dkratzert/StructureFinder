...
class Ui_stdbMainwindow(object):
    def setupUi(self, stdbMainwindow):
        ...
        self.NotContainsLabel.setStyleSheet("background-color: rgb(255, 147, 147);")
        ...
        self.containsLabel.setStyleSheet("background-color: rgb(123, 255, 127);")
        ...
        self.gridLayout_4.addWidget(self.ad_unitCellLineEdit, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.unitCellLabel, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.ad_moreResultscheckBox, 1, 2, 1, 1)
        ...
        self.gridLayout_6.addItem(spacerItem10, 4, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.ad_SearchPushButton, 2, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.ad_ShowAll = QtWidgets.QPushButton(self.searchtab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ad_ShowAll.sizePolicy().hasHeightForWidth())
        self.ad_ShowAll.setSizePolicy(sizePolicy)
        self.ad_ShowAll.setMinimumSize(QtCore.QSize(150, 0))
        self.ad_ShowAll.setObjectName("ad_ShowAll")
        self.gridLayout_6.addWidget(self.ad_ShowAll, 3, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        stdbMainwindow.setTabOrder(self.ad_textsearch_excl, self.ad_SearchPushButton)
    ...
    def retranslateUi(self, stdbMainwindow):
        ...
        self.ad_ShowAll.setText(_translate("stdbMainwindow", "Show All"))
