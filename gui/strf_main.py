...
class Ui_stdbMainwindow(object):
    def setupUi(self, stdbMainwindow):
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.wavelengthLabel)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.wavelengthLineEdit)
