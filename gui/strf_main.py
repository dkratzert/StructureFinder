...
class Ui_stdbMainwindow(object):
    def setupUi(self, stdbMainwindow):
        ...
        stdbMainwindow.setTabOrder(self.rsigmaLineEdit, self.reflTotalLineEdit)
        stdbMainwindow.setTabOrder(self.reflTotalLineEdit, self.numParametersLineEdit)
    ...
    def retranslateUi(self, stdbMainwindow):
        ...
        self.searchCellLineEDit.setToolTip(_translate("stdbMainwindow", "<html><head/><body><p>Insert unit cell as space separated: <br><span style=\" font-style:italic;\">a b c α β γ</span></p></body></html>"))
        ...
        self.sublattCheckbox.setText(_translate("stdbMainwindow", "sub- and superlattice"))
